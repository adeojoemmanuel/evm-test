...
export interface USDKInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface USDK extends BaseContract {
  connect(runner?: ContractRunner | null): USDK;
  waitForDeployment(): Promise<this>;

  interface: USDKInterface;
